...
ALTER TABLE record_comment ADD INDEX index_1(value);
ALTER TABLE record ADD INDEX index_2(value);
ALTER TABLE record_item_file ADD INDEX index_3(value);
ALTER TABLE session ADD INDEX indedx_4(value);
